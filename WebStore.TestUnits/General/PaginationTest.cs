...
namespace WebStore.UnitTests
{
    ...
    public class PaginationTest {
        ...
        public void SetSessopmVars()
        {
            UserSessionData.UserLoggedOn = true;
            UserSessionData.UserId = 1;
        }
        ...
        public void Generate_Category_Specific_Product_Count() {
            ...
            Mock<IProductRepository> mock = new Mock<IProductRepository>();
            mock.Setup(m => m.Products).Returns(new Product[] {
                new Product {ProductID = 1, Name = "P1", Category = "Cat1", Quantity=1},
                new Product {ProductID = 2, Name = "P2", Category = "Cat2", Quantity=1},
                new Product {ProductID = 3, Name = "P3", Category = "Cat1", Quantity=1},
                new Product {ProductID = 4, Name = "P4", Category = "Cat2", Quantity=1},
                new Product {ProductID = 5, Name = "P5", Category = "Cat3", Quantity=1}
            });
